...
class InicializadorScrcpyPro(ctk.CTk):
    ...
    def criar_painel_esquerdo(self):
        ...
        lbl_disp = ctk.CTkLabel(self.painel_esquerdo, text="📱 DISPOSITIVOS", font=("Arial", 12, "bold"))
        ...
        self.btn_atualizar_adb = ctk.CTkButton(self.painel_esquerdo, text="🔄 Atualizar ADB", width=35, command=self.motor.atualizar_lista_dispositivos)
        self.btn_atualizar_adb.pack(pady=10)
        
        ctk.CTkFrame(self.painel_esquerdo, height=5, fg_color="gray30").pack(fill="x", padx=30, pady=10)
